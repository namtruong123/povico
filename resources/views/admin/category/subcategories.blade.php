{{-- filepath: resources/views/admin/category/subcategories.blade.php --}}
@extends('admin.admin')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.categories.create') }}" class="btn btn-primary">Thêm danh mục con</a>
                </div>
                        ...
                        <table class="table table-bordered table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($cat->image)
                                            <img src="{{ asset('assets/images/category/' . $cat->image) }}" alt="Ảnh" width="50">
                                        @endif
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="7" class="text-center text-muted">Không có danh mục con nào.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
